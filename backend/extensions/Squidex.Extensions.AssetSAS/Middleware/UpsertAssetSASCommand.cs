...
/// <summary>
/// An upsert asset sas command.
/// </summary>
public class UpsertAssetSASCommand : UploadAssetSASCommand
{
    /// <summary>
    ...
    public override UploadAssetCommand ToCommand()
    {
        ...
        var command = SimpleMapper.Map(this, new UpsertAsset { File = file, FileHash = FileHash, AppId = AppId });
        return command;
    }
}
